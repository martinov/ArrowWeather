...
module.exports = {
	...
	admin: {
		...
		validEmails: ["martin@mmartinov.com"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [402213287595824]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: 'tzZnIQacic19cXOgnuHpPf29r/XptyTQPq7vzREhmwg=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'YUZl+UAKS4qVumzQidMz/h9ZXrCeKfZKNv+cTcdDPzLpBFCvZDnEXo0fnoCgZ2KEHaX+wtnxvKYUvvE4S+lU5w==',
		secret: 'CJV0snQeAD1NAo2xKz+qoe8KRlxStvD7', // should be a large unguessable string
	...
	cookieSecret: 'vQvns/LbQlWWqBZKbyR1uvfnm72md0pH',
